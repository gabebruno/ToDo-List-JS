(function (window) {
	...
	function Controller(model, view) {
		...
		that.view.bind('itemMark', function (item) {
			that.markItem(item.id);
		});
	 ...
	 *
	 * @param {number} id The ID of the item to mark 
	 */
	Controller.prototype.markItem = function (id) {
		var that = this;

		that.model.mark(id, function (data) {
			that.view.render('markItem', {id: id, mark: data.mark});
		});
	};
